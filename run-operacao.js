...
function getMenuHelpText(option) {
    const details = {
        ...
        '7': [
            ...
            '- Se nao houver OLA configurado para a quantidade de validadores encontrada, a tabela continua sendo gerada sem coloracao para esse caso e com aviso no terminal.',
            '',
            'Saidas geradas:',
